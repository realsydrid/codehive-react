        ...
        <Navbar expand='md' bg={"dark"} variant={"dark"} style={{position:"fixed",top:"3rem"
            ,left:0,marginLeft:0,minWidth:"32rem",width:"100%",maxWidth:"1000rem"}}>
                ...
                <Navbar.Collapse id="freePost" style={{marginLeft:"1rem",marginRight:"1rem"}} >
                    <Nav
                        style={{ height:'auto' ,maxHeight: '100px',minWidth:"32rem",width:"95%",maxWidth:"100rem"
                            ,display:"flex"
                    ...
                    >
                        ...
                        <Nav.Link href="/community/expert"style={{color:"white",margin:"0.2rem 2rem 0.2rem 5rem"}}>전문가 게시판</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
        </Navbar>
